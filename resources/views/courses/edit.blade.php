         ...
         <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" style="height:150px" name="description" placeholder="slug">{{ $course->description }}</textarea>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <div class="form-group">
                    ...
                    <input type="file" name="image" value="{{$course->slug}}" />
